...
baseurl=https://archive.kernel.org/centos-vault/8.5.2111/BaseOS/x86_64/os/
enabled=1
gpgcheck=0

[appstream]
name=CentOS-8.5.2111 AppStream
baseurl=https://archive.kernel.org/centos-vault/8.5.2111/AppStream/x86_64/os/
enabled=1
gpgcheck=0

[extras]
name=CentOS-8.5.2111 Extras
baseurl=https://archive.kernel.org/centos-vault/8.5.2111/extras/x86_64/os/
enabled=1
gpgcheck=0
EOF
